...
function Modal() {
    ...
    const [val, setVal] = useRecoilState(caseState)
    ...
    return (
        <Transition.Root show={isOpen} as={Fragment}>
            <Dialog as="div" className="fixed z-50 inset-0 pt-8" onClose={setIsOpen}>
                <div className="flex items-start overflow-visible justify-center min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    <Transition.Child
                        as={Fragment}
                                    ...
                                    <div className="mt-7 flex space-x-3 w-full">
                                        ...
                                        <div className="flex-grow mt-2">
                                            <textarea
                                                ...
                                                rows="2"
                                                className="bg-transparent outline-none text-[#d9d9d9] text-lg  scrollbar-hide placeholder-gray-500 tracking-wide w-full min-h-[80px]"
                                            />
